...
Promise.resolve().then(() => __importStar(require('./index'))).then((serverModule) => {
    ...
    ╚═╝     ╚═╝  ╚═╝ ╚═════╝╚═════╝ ╚══════╝╚══════╝╚══════╝╚══════╝
    `);
        console.warn('\x1b[35m%s\x1b[0m', '                    By Ken Kai does AI');
        console.warn('\x1b[90m%s\x1b[0m', '    ═══════════════════════════════════════════════════════════\n');
        ...
        console.warn(`    \x1b[32m✓\x1b[0m Environment: \x1b[33m${process.env.NODE_ENV || 'production'}\x1b[0m\n`);
