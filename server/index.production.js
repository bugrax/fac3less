...
Promise.resolve().then(() => __importStar(require('./index'))).then((serverModule) => {
    ...
    ╚═╝     ╚═╝  ╚═╝ ╚═════╝╚═════╝ ╚══════╝╚══════╝╚══════╝╚══════╝
    `);
        console.log('\x1b[35m%s\x1b[0m', '                    By Ken Kai does AI');
        console.log('\x1b[90m%s\x1b[0m', '    ═══════════════════════════════════════════════════════════\n');
        // Server info with colors
        console.log('    \x1b[32m✓\x1b[0m Server Status: \x1b[32mONLINE\x1b[0m');
        console.log(`    \x1b[32m✓\x1b[0m Port: \x1b[33m${PORT}\x1b[0m`);
        console.log(`    \x1b[32m✓\x1b[0m Environment: \x1b[33m${process.env.NODE_ENV || 'production'}\x1b[0m\n`);
        // Clickable URL with styling
        const url = `http://localhost:${PORT}`;
        console.log('    \x1b[36m🌐 Access your application at:\x1b[0m\n');
        console.log(`    \x1b[1m\x1b[4m\x1b[36m${url}\x1b[0m\n`);
        // Additional info
