import { r as S, j as he } from './workflow-DLvrlcxk.js';
const ws = S.createContext({});
function nr(t) {
  const e = S.useRef(null);
  return (e.current === null && (e.current = t()), e.current);
}
const Le = typeof window < 'u',
  sr = Le ? S.useLayoutEffect : S.useEffect,
  ke = S.createContext(null);
function Fe(t, e) {
...
function ar(t, e, n, s, i) {
  let o,
    ...
    a = 0;
  do {
    ((r = e + (n - e) / 2), (o = Es(r, s, i) - t), o > 0 ? (n = r) : (e = r));
  } while (Math.abs(o) > rr && ++a < or);
  return r;
}
function Rt(t, e, n, s) {
  if (t === e && n === s) {
...
const Rs = t => e => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
  Ls = t => e => 1 - t(1 - e),
  ks = Rt(0.33, 1.53, 0.69, 0.99),
  Ne = Ls(ks),
  Fs = Rs(Ne),
  Bs = t =>
    (t *= 2) < 1 ? 0.5 * Ne(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1))),
  ...
  ur = Rt(0, 0, 0.58, 1),
  js = Rt(0.42, 0, 0.58, 1),
  cr = t => Array.isArray(t) && typeof t[0] !== 'number',
...
function Us(t, e) {
  ...
  const i = { delta: 0, timestamp: 0, isProcessing: !1 },
    ...
    v = () => {
      ...
      ((n = !1),
      X.useManualTiming ||
          (i.delta = s ? 1e3 / 60 : Math.max(Math.min(g - i.timestamp, mr), 1)),
      (i.timestamp = g),
      (i.isProcessing = !0),
      a.process(i),
      l.process(i),
  ...
  return {
    schedule: Ft.reduce((g, A) => {
      const P = r[A];
      return (
        (g[A] = (w, R = !1, b = !1) => (n || y(), P.schedule(w, R, b))),
        g
      );
    }, {}),
    cancel: g => {
...
const {
  ...
  state: L,
  steps: Zt
} = Us(typeof requestAnimationFrame < 'u' ? requestAnimationFrame : K, !0);
let Ot;
function pr() {
  Ot = void 0;
}
const O = {
    ...
    set: t => {
      ((Ot = t), queueMicrotask(pr));
    }
  },
  Ks = t => e => typeof e === 'string' && e.startsWith(t),
  Ke = Ks('--'),
  gr = Ks('var(--'),
  We = t => (gr(t) ? yr.test(t.split('/*')[0].trim()) : !1),
  yr =
...
const Tr =
  ...
  Ge = (t, e) => n =>
    !!(
      (typeof n === 'string' && Tr.test(n) && n.startsWith(t)) ||
  ...
  xr = t => z(0, 255, t),
  Jt = { ...dt, transform: t => Math.round(xr(t)) },
  et = {
    test: Ge('rgb', 'red'),
    parse: Ws('red', 'green', 'blue'),
    transform: ({ red: t, green: e, blue: n, alpha: s = 1 }) =>
      `rgba(${Jt.transform(t)}, ${Jt.transform(e)}, ${Jt.transform(n)}, ${vt(
        At.transform(s)
      )})`
  };
function Pr(t) {
...
const fe = { test: Ge('#'), parse: Pr, transform: et.transform },
  Lt = t => ({
    test: e =>
  ...
  ot = {
    test: Ge('hsl', 'hue'),
    parse: Ws('hue', 'saturation', 'lightness'),
    transform: ({ hue: t, saturation: e, lightness: n, alpha: s = 1 }) =>
      `hsla(${Math.round(t)}, ${H.transform(vt(e))}, ${H.transform(
        vt(n)
      )}, ${vt(At.transform(s))})`
  },
  E = {
    test: t => et.test(t) || fe.test(t) || ot.test(t),
    parse: t =>
      et.test(t) ? et.parse(t) : ot.test(t) ? ot.parse(t) : fe.parse(t),
    transform: t =>
      typeof t === 'string'
        ? t
...
function wr(t) {
  return (
    isNaN(t) &&
    typeof t === 'string' &&
    (t.match($e)?.length || 0) + (t.match(Ar)?.length || 0) > 0
  );
}
const $s = 'number',
  Gs = 'color',
...
function wt(t) {
  ...
  const a = e
    .replace(
      ...
      l => (
        E.test(l)
          ? (s.color.push(o), i.push(Gs), n.push(E.parse(l)))
          : l.startsWith(Mr)
            ? (s.var.push(o), i.push(Vr), n.push(l))
            : (s.number.push(o), i.push($s), n.push(parseFloat(l))),
        ++o,
        pn
      )
    )
...
function Er(t) {
  const e = Hs(t);
  return _s(t)(e.map(Cr));
}
const Z = { test: wr, parse: Hs, createTransformer: _s, getAnimatableNone: Er };
function Qt(t, e, n) {
  return (
    n < 0 && (n += 1),
    n > 1 && (n -= 1),
...
function Wr({
  ...
  let i,
    o,
    r = 1 - e;
  ((r = z(D.minDamping, D.maxDamping, r)),
  (t = z(D.minDuration, D.maxDuration, G(t))),
  r < 1
    ? ((i = c => {
      const u = c * r,
        h = u * t,
...
function $t(t = D.visualDuration, e = D.bounce) {
  const n =
    typeof t !== 'object'
  ...
  if (v < 1) {
    ...
    g = w => {
      const R = Math.exp(-v * p * w),
        b = Math.min(P * w, 300);
      return (
        r - (R * ((m + v * p * y) * Math.sinh(b) + P * y * Math.cosh(b))) / P
      );
    };
  }
  const A = {
    ...
    toString: () => {
      const P = Math.min(_e(A), Wt),
        w = Ys(R => A.next(P * R).value, P, 30);
      return `${P}ms ${w}`;
    },
    toTransition: () => {}
  };
  ...
  return (
    R(0),
    {
      ...
      next: b => {
        let I = !1;
        return (
          !w && P === void 0 && ((I = !0), A(b), R(b)),
          P !== void 0 && b >= P ? w.next(b - P) : (!I && A(b), f)
        );
      }
    }
  );
...
function Yr(t, e, { clamp: n = !0, ease: s, mixer: i } = {}) {
  const o = t.length;
  if ((Ie(o === e.length), o === 1)) {
    return () => e[0];
  }
  if (o === 2 && e[0] === e[1]) {
    return () => e[1];
...
function Qr(t, e) {
  return t.map(() => e || js).splice(0, t.length - 1);
}
function Tt({
  duration: t = 300,
  keyframes: e,
  ...
  const i = cr(s) ? s.map(dn) : dn(s),
    o = { done: !1, value: e[0] },
    r = Jr(n && n.length === e.length ? n : Zr(e), t),
    a = Yr(r, e, { ease: Array.isArray(i) ? i : Qr(e, i) });
  return {
...
const eo = { decay: pe, inertia: pe, tween: Tt, keyframes: Tt, spring: $t };
function Zs(t) {
  typeof t.type === 'string' && (t.type = eo[t.type]);
}
class Xe {
  constructor() {
    this.updateFinished();
...
class Ye extends Xe {
  ...
  initAnimation() {
    ...
    l !== Tt &&
      typeof a[0] !== 'number' &&
      ((this.mixKeyframes = Et(no, Xs(a[0], a[1]))), (a = [0, 100]));
  ...
  tick(e, n = !1) {
    ...
    const P = T ? { done: !1, value: u[0] } : A.next(g);
    o && (P.value = o(P.value));
    let { done: w } = P;
    !T &&
      l !== null &&
    ...
    return (
      R && m !== pe && (P.value = ze(u, this.options, y, this.speed)),
      v && v(P.value),
      R && this.finish(),
      P
    );
  ...
  play() {
    ...
    const { driver: e = Nr, startTime: n } = this.options;
...
const nt = t => (t * 180) / Math.PI,
  ...
  Pn = t => Math.sqrt(t[4] * t[4] + t[5] * t[5]),
  ro = {
    x: 12,
    y: 13,
    z: 14,
    ...
    scaleY: Pn,
    scale: t => (xn(t) + Pn(t)) / 2,
    rotateX: t => ye(nt(Math.atan2(t[6], t[5]))),
    rotateY: t => ye(nt(Math.atan2(-t[2], t[0]))),
    rotateZ: Tn,
    rotate: Tn,
...
function Js() {
  ...
  ((Pe = !1), (xe = !1), it.forEach(t => t.complete(Se)), it.clear());
}
function Qs() {
  it.forEach(t => {
...
class qe {
  ...
  scheduleResolve() {
    ...
    this.isAsync
      ? (it.add(this), xe || ((xe = !0), V.read(Qs), V.resolveKeyframes(Js)))
...
const po = Oe(() => window.ScrollTimeline !== void 0),
  go = {};
function yo(t, e) {
  const n = Oe(t);
  return () => go[e] ?? n();
...
const ti = yo(() => {
  ...
  yt = ([t, e, n, s]) => `cubic-bezier(${t}, ${e}, ${n}, ${s})`,
  bn = {
    linear: 'linear',
    ease: 'ease',
    easeIn: 'ease-in',
...
class xo extends Xe {
  constructor(e) {
    ...
    (this.animation.onfinish = () => {
      if (((this.finishedTime = this.time), !o)) {
        ...
        (this.updateMotionValue ? this.updateMotionValue(u) : mo(n, s, u),
  ...
  attachTimeline({ timeline: e, observe: n }) {
    return (
      ...
      e && po() ? ((this.animation.timeline = e), K) : n(this)
    );
  }
}
const si = { anticipate: Bs, backInOut: Fs, circInOut: Os };
function Po(t) {
  return t in si;
}
function So(t) {
  typeof t.ease === 'string' && Po(t.ease) && (t.ease = si[t.ease]);
}
const An = 10;
class bo extends xo {
  constructor(e) {
  ...
  updateMotionValue(e) {
    ...
    const a = new Ye({ ...r, autoplay: !1 }),
      l = $(this.finishedTime ?? this.time);
    (n.setWithVelocity(a.sample(l - An).value, a.sample(l).value, An),
    a.stop());
  }
}
const wn = (t, e) =>
...
function wo(t, e, n, s) {
  ...
  const o = t[t.length - 1],
    r = wn(i, e),
    a = wn(o, e);
  return !r || !a ? !1 : Ao(t) || ((n === 'spring' || ni(n)) && s);
}
const Vo = new Set(['opacity', 'clipPath', 'filter', 'transform']),
  Mo = Oe(() => Object.hasOwnProperty.call(Element.prototype, 'animate'));
function Do(t) {
  const {
    motionValue: e,
    name: n,
...
class Eo extends Xe {
  ...
  onKeyframesResolved(e, n, s, i) {
    ...
    wo(e, o, r, a) ||
        ((X.instantAnimations || !l) && u?.(ze(e, s, n)),
        (e[0] = e[e.length - 1]),
        (s.duration = 0),
        (s.repeat = 0)));
    const f = {
        startTime: i
          ? this.resolvedAt
            ? this.resolvedAt - this.createdAt > Co
              ? this.resolvedAt
              : this.createdAt
            : this.createdAt
          : void 0,
      ...
      d =
        !c && Do(f)
          ? new bo({ ...f, element: f.motionValue.owner.current })
          : new Ye(f);
  ...
  get animation() {
    return (
      this._animation || (this.keyframeResolver?.resume(), ho()),
      this._animation
    );
  }
  get duration() {
...
const ri = new Set([
  ...
  ko = { test: t => t === 'auto', parse: t => t },
  oi = t => e => e.test(t),
  ai = [dt, x, H, Y, br, Sr, ko],
  Vn = t => ai.find(oi(t));
function Fo(t) {
  return typeof t === 'number'
    ? t === 0
...
const Bo = new Set(['brightness', 'contrast', 'saturate', 'opacity']);
function Io(t) {
...
function Ko(t, e, n) {
  ...
  for (; s < t.length && !i; ) {
    const o = t[s];
    (typeof o === 'string' && !Uo.has(o) && wt(o).values.length && (i = t[s]),
    s++);
  }
  if (i && n) {
    for (const o of e) {
...
const ci = (t, e) => (e && typeof t === 'number' ? e.transform(t) : t);
function Go(t) {
  return Ms(t) && 'offsetHeight' in t;
}
const Dn = 30,
  Ho = t => !isNaN(parseFloat(t));
class _o {
  constructor(e, n = {}) {
  ...
  setCurrent(e) {
    ...
    this.canTrackVelocity === null &&
        e !== void 0 &&
        (this.canTrackVelocity = Ho(this.current)));
  }
...
const { schedule: Qe } = Us(queueMicrotask, !1),
  W = { x: !1, y: !1 };
function hi() {
  return W.x || W.y;
}
...
function Xo(t, e, n = {}) {
  const [s, i, o] = fi(t, n),
    r = a => {
      ...
      const u = h => {
        Cn(h) && (c(h), l.removeEventListener('pointerleave', u));
      };
...
const di = (t, e) => (e ? (t === e ? !0 : di(t, e.parentElement)) : !1),
  tn = t =>
    t.pointerType === 'mouse'
      ...
      : t.isPrimary !== !1,
  Yo = new Set(['BUTTON', 'INPUT', 'SELECT', 'TEXTAREA', 'A']);
function qo(t) {
  return Yo.has(t.tagName) || t.tabIndex !== -1;
}
...
function Jo(t, e, n = {}) {
    ...
    r = a => {
      ...
      const c = e(l, a),
        u = (d, m) => {
          ...
          Rn(d) && typeof c === 'function' && c(d, { success: m }));
        },
        h = d => {
          u(
            d,
  ...
  return (
    s.forEach(a => {
      ...
      Go(a) &&
          (a.addEventListener('focus', c => Zo(c, i)),
          !qo(a) && !a.hasAttribute('tabindex') && (a.tabIndex = 0)));
    }),
    o
  );
}
...
const gi = S.createContext({ strict: !1 }),
  Ln = {
    animation: [
      'animate',
      'variants',
  ...
  ft = {};
for (const t in Ln) {
  ft[t] = { isEnabled: e => Ln[t].some(n => !!e[n]) };
}
function sa(t) {
  for (const e in t) {
    ft[e] = { ...ft[e], ...t[e] };
...
let yi = t => !Gt(t);
function ra(t) {
  typeof t === 'function' && (yi = e => (e.startsWith('on') ? !Gt(e) : t(e)));
}
try {
...
const en = [
  ...
  nn = ['initial', ...en];
function Xt(t) {
  return zt(t.animate) || nn.some(e => Vt(t[e]));
}
function vi(t) {
...
function la(t) {
  const { initial: e, animate: n } = aa(t, S.useContext(_t));
  return S.useMemo(() => ({ initial: e, animate: n }), [kn(e), kn(n)]);
}
function kn(t) {
...
function ua(t) {
  for (const e in t) {
    ((Mt[e] = t[e]), Ke(e) && (Mt[e].isCSSVariable = !0));
  }
}
...
function sn(t, e, n) {
  ...
  if (
    (e.transform ||
      (r || n
        ? (s.transform = fa(e, t.transform, n))
...
function xi(t, e, n) {
  for (const s in e) {
    !k(e[s]) && !Ti(s, n) && (t[s] = e[s]);
  }
}
function da({ transformTemplate: t }, e) {
  return S.useMemo(() => {
    const n = rn();
...
function ma(t, e) {
  const n = t.style || {},
    s = {};
  return (xi(s, n, t), Object.assign(s, da(t, e)), s);
}
function pa(t, e) {
  const n = {},
    s = ma(t, e);
...
const ga = { offset: 'stroke-dashoffset', array: 'stroke-dasharray' },
  ya = { offset: 'strokeDashoffset', array: 'strokeDasharray' };
...
function Ta(t, e, n, s) {
  const i = S.useMemo(() => {
    const o = Si();
    return (
      Pi(o, e, bi(s), t.transformTemplate, t.style),
      { ...o.attrs, style: { ...o.style } }
    );
  }, [e]);
  if (t.style) {
    const o = {};
    (xi(o, t.style, t), (i.style = { ...o, ...i.style }));
  }
  return i;
}
const xa = [
...
function on(t) {
  return typeof t !== 'string' || t.includes('-')
    ? !1
    : !!(xa.indexOf(t) > -1 || /[A-Z]/u.test(t));
}
function Pa(t, e, n, { latestValues: s }, i, o = !1) {
  const a = (on(t) ? Ta : pa)(e, s, i, t),
    l = oa(e, typeof t === 'string', o),
...
function Sa({ scrapeMotionValuesFromProps: t, createRenderState: e }, n, s, i) {
  return { latestValues: ba(n, s, i, t), renderState: e() };
}
function ba(t, e, n, s) {
  const i = {},
    o = s(t, {});
...
const Aa = Ai({ scrapeMotionValuesFromProps: ln, createRenderState: rn });
function wi(t, e, n) {
  const s = ln(t, e, n);
  for (const i in t) {
    if (k(t[i]) || k(e[i])) {
...
const wa = Ai({ scrapeMotionValuesFromProps: wi, createRenderState: Si }),
...
function Ca(t, e, n, s, i) {
  const { visualElement: o } = S.useContext(_t),
    r = S.useContext(gi),
    a = S.useContext(ke),
...
function Ea(t, e, n, s) {
  ...
  ((t.projection = new n(
    t.latestValues,
    e['data-framer-portal-id'] ? void 0 : Di(t.parent)
  )),
...
function se(t, { forwardMotionProps: e = !1 } = {}, n, s) {
  n && sa(n);
  const i = on(t) ? wa : Aa;
  function o(a, l) {
    let c;
    const u = { ...S.useContext(pi), ...a, layoutId: Ra(a) },
      { isStatic: h } = u,
      f = la(a),
      d = i(a, h);
    if (!h && Le) {
      ...
      const m = ka(u);
      ((c = m.MeasureLayout),
      (f.visualElement = Ca(t, d, u, s, m.ProjectionNode)));
    }
    return he.jsxs(_t.Provider, {
      value: f,
      children: [
        c && f.visualElement
          ? he.jsx(c, { visualElement: f.visualElement, ...u })
          : null,
        Pa(t, a, Ma(d, f.visualElement, l), d, h, e)
      ]
    });
  }
...
function Ra({ layoutId: t }) {
  const e = S.useContext(ws).id;
  return e && t !== void 0 ? `${e}-${t}` : t;
}
function La(t, e) {
  S.useContext(gi).strict;
}
function ka(t) {
...
function Fa(t, e) {
  ...
  return new Proxy(i, {
    get: (o, r) =>
      r === 'create'
        ? s
        : (n.has(r) || n.set(r, se(r, void 0, t, e)), n.get(r))
  });
}
...
function we(t, e = 0, n = 1, s, i) {
  ((t.min = In(t.min, e, n, s, i)), (t.max = In(t.max, e, n, s, i)));
}
function Ri(t, { x: e, y: n }) {
  (we(t.x, e.translate, e.scale, e.originPoint),
  we(t.y, n.translate, n.scale, n.originPoint));
}
const On = 0.999999999999,
  jn = 1.0000000000001;
function Oa(t, e, n, s = !1) {
  ...
  for (let a = 0; a < i; a++) {
    ...
    (l && l.props.style && l.props.style.display === 'contents') ||
      ...
      r && ((e.x *= r.x.scale), (e.y *= r.y.scale), Ri(t, r)),
      s && tt(o.latestValues) && ut(t, o.latestValues));
  }
  (e.x < jn && e.x > On && (e.x = 1), e.y < jn && e.y > On && (e.y = 1));
}
function lt(t, e) {
  ((t.min = t.min + e), (t.max = t.max + e));
}
function Nn(t, e, n, s, i = 0.5) {
...
function Li(t, e) {
  return Ci(Ia(t.getBoundingClientRect(), e));
}
function ja(t, e, n) {
  const s = Li(t, n),
    { scroll: i } = e;
...
const Un = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
  ct = () => ({ x: Un(), y: Un() }),
  Kn = () => ({ min: 0, max: 0 }),
  C = () => ({ x: Kn(), y: Kn() }),
  Ve = { current: null },
...
class Wa {
  ...
  readValue(e, n) {
    ...
    return (
      s != null &&
        (typeof s === 'string' && (Vs(s) || Ds(s))
          ? (s = parseFloat(s))
          : !ea(s) && Z.test(n) && (s = ui(e, n)),
...
function Bi(t, { style: e, vars: n }, s, i) {
  const o = t.style;
  let r;
  for (r in e) {
    o[r] = e[r];
...
class Ga extends Fi {
  ...
  readValueFromInstance(e, n) {
    if (pt.has(n)) {
      return this.projection?.isProjecting ? ve(n) : oo(e, n);
    }
    {
      const s = $a(e),
        i = (Ke(n) ? s.getPropertyValue(n) : s[n]) || 0;
...
function Ha(t, e, n, s) {
  ...
  for (const i in e.attrs) {
    t.setAttribute(Ii.has(i) ? i : un(i), e.attrs[i]);
  }
}
class _a extends Fi {
  constructor() {
  ...
  readValueFromInstance(e, n) {
    ...
    return ((n = Ii.has(n) ? n : un(n)), e.getAttribute(n));
  }
  scrapeMotionValuesFromProps(e, n, s) {
    return wi(e, n, s);
  }
  build(e, n, s) {
    Pi(e, n, this.isSVGTag, s.transformTemplate, s.style);
  }
...
const za = (t, e) =>
  on(t) ? new _a(e) : new Ga(e, { allowProjection: t !== S.Fragment });
function Dt(t, e, n) {
  const s = t.getProps();
...
const Ja = t => t !== null;
function Qa(t, { repeat: e, repeatType: n = 'loop' }, s) {
  const i = t.filter(Ja),
    o = e && n !== 'loop' && e % 2 === 1 ? 0 : i.length - 1;
  return i[o];
}
const tl = { type: 'spring', stiffness: 500, damping: 25, restSpeed: 10 },
  el = t => ({
    type: 'spring',
    stiffness: 550,
  ...
  nl = { type: 'keyframes', duration: 0.8 },
  sl = { type: 'keyframes', ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
  il = (t, { keyframes: e }) =>
    e.length > 2
      ? nl
      : pt.has(t)
...
const cn =
  (t, e, n, s = {}, i, o) =>
    r => {
      ...
      return a.isSync ? new Ye(u) : new Eo(u);
    };
...
function ji(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
  ...
  for (const u in a) {
    const h = t.getValue(u, t.latestValues[u] ?? null),
      f = a[u];
    if (f === void 0 || (c && ol(c, u))) {
      continue;
    }
    const d = { delay: n, ...Ze(o || {}, u) },
      m = h.get();
    if (
      m !== void 0 &&
      !h.isAnimating &&
    ...
    (De(t, u),
    h.start(
      cn(u, h, f, t.shouldReduceMotion && ri.has(u) ? { type: !1 } : d, t, v)
    ));
    const y = h.animation;
    y && l.push(y);
  }
...
function Ce(t, e, n = {}) {
  ...
  const o = s ? () => Promise.all(ji(t, s, n)) : () => Promise.resolve(),
    r =
...
function al(t, e, n = 0, s = 0, i = 0, o = 1, r) {
  const a = [],
...
const hl = [...en].reverse(),
  fl = en.length;
function dl(t) {
  return e => Promise.all(e.map(({ animation: n, options: s }) => ul(t, n, s)));
}
function ml(t) {
  let e = dl(t),
    n = $n(),
  ...
  function r(l) {
    ...
    for (let y = 0; y < fl; y++) {
      ...
      const R = pl(T.prevProp, g);
      let b = R || (p === l && T.isActive && !w && A) || (y > m && A),
        I = !1;
      const j = Array.isArray(g) ? g : [g];
      let rt = j.reduce(i(p), {});
      P === !1 && (rt = {});
      const { prevResolvedValues: hn = {} } = T,
        er = { ...hn, ...rt },
        fn = F => {
          ((b = !0),
      ...
      b &&
          (!(w && R) || I) &&
          h.push(...j.map(F => ({ animation: F, options: { type: p } }))));
    }
    if (f.size) {
      const y = {};
...
const Tl = { animation: { Feature: gl }, exit: { Feature: vl } };
function Ct(t, e, n, s = { passive: !0 }) {
  return (t.addEventListener(e, n, s), () => t.removeEventListener(e, n));
}
function kt(t) {
  return { point: { x: t.pageX, y: t.pageY } };
}
const xl = t => e => tn(e) && t(e, kt(e));
function xt(t, e, n, s) {
  return Ct(t, e, xl(n), s);
}
const Ki = 1e-4,
  Pl = 1 - Ki,
  Sl = 1 + Ki,
...
function Gn(t, e, n, s = 0.5) {
  ...
  ((t.scale >= Pl && t.scale <= Sl) || isNaN(t.scale)) && (t.scale = 1),
  ((t.translate >= bl && t.translate <= Al) || isNaN(t.translate)) &&
      (t.translate = 0));
}
function Pt(t, e, n, s) {
  (Gn(t.x, e.x, n.x, s ? s.originX : void 0),
  Gn(t.y, e.y, n.y, s ? s.originY : void 0));
}
function Hn(t, e, n) {
  ...
  constructor(
    ...
    if (
      ...
      (this.updatePoint = () => {
        ...
        const f = oe(this.lastMoveEventInfo, this.history),
          d = this.startEvent !== null,
          m = Ml(f.offset, { x: 0, y: 0 }) >= this.distanceThreshold;
        if (!d && !m) {
          return;
        }
        const { point: v } = f,
    ...
    const a = kt(e),
      l = re(a, this.transformPagePoint),
      { point: c } = l,
      { timestamp: u } = L;
    this.history = [{ ...c, timestamp: u }];
    const { onSessionStart: h } = n;
    (h && h(e, oe(l, this.history)),
...
function Rl(t, { top: e, left: n, bottom: s, right: i }) {
  return { x: Yn(t.x, n, i), y: Yn(t.y, e, s) };
}
function qn(t, e) {
  let n = e.min - t.min,
    s = e.max - t.max;
...
function Ll(t, e) {
  return { x: qn(t.x, e.x), y: qn(t.y, e.y) };
}
function kl(t, e) {
  let n = 0.5;
  const s = B(t),
  ...
  return (
    i > s
      ? (n = bt(e.min, e.max - s, t.min))
      : s > i && (n = bt(t.min, t.max - i, e.min)),
    z(0, 1, n)
  );
}
function Fl(t, e) {
...
function Bl(t = Ee) {
  return (
    t === !1 ? (t = 0) : t === !0 && (t = Ee),
    { x: Zn(t, 'left', 'right'), y: Zn(t, 'top', 'bottom') }
  );
}
function Zn(t, e, n) {
...
class Ol {
  ...
  start(e, { snapToCursor: n = !1, distanceThreshold: s } = {}) {
    ...
    const o = h => {
        ...
        n && this.snapToCursor(kt(h).point));
      },
      r = (h, f) => {
        ...
        De(this.visualElement, 'transform'));
  ...
  updateAxis(e, n, s) {
    ...
    (this.constraints &&
      this.constraints[e] &&
      (r = El(r, this.constraints[e], this.elastic[e])),
    o.set(r));
  }
  resolveConstraints() {
    ...
    (e && at(e)
      ...
      : e && s
        ? (this.constraints = Rl(s.layoutBox, e))
        : (this.constraints = !1),
    (this.elastic = Bl(n)),
    i !== this.constraints &&
        s &&
        ...
        U(o => {
          this.constraints !== !1 &&
            ...
            (this.constraints[o] = Fl(s.layoutBox[o], this.constraints[o]));
        }));
  }
  ...
  startAxisValueAnimation(e, n) {
    ...
    return (
      De(this.visualElement, e),
      s.start(cn(e, s, 0, n, this.visualElement, !1))
    );
  }
  stopAnimation() {
  ...
  scalePositionWithinConstraints() {
    ...
    U(r => {
      ...
      if (a && this.constraints !== !1) {
        const l = a.get();
        i[r] = kl({ min: l, max: l }, this.constraints[r]);
      }
    });
  ...
  addListeners() {
    ...
    Il.set(this.visualElement, this);
    ...
    V.read(s));
    const r = Ct(window, 'resize', () => this.scalePositionWithinConstraints()),
...
class Ul extends J {
  ...
  mount() {
    this.removePointerDownListener = xt(this.node.current, 'pointerdown', e =>
...
function _i(t) {
  ...
  return he.jsx(Wl, {
    ...t,
    layoutGroup: s,
    switchLayoutGroup: S.useContext(Mi),
    isPresent: e,
    safeToRemove: n
  });
}
...
class _l {
  ...
  forEach(e) {
    (this.isDirty && this.children.sort(Hl),
    (this.isDirty = !1),
...
function Yl(t, e, n, s, i, o) {
  i
    ? ((t.opacity = M(0, n.opacity ?? 1, ql(s))),
    (t.opacityExit = M(e.opacity ?? 1, 0, Zl(s))))
...
function as(t, e, n, s, i) {
  return (
    (t -= e),
    (t = Ht(t, 1 / n, s)),
    i !== void 0 && (t = Ht(t, 1 / i, s)),
    t
  );
}
function Jl(t, e = 0, n = 1, s = 0.5, i, o = t, r = t) {
  if (
    (H.test(e) && ((e = parseFloat(e)), (e = M(r.min, r.max, e / 100) - r.min)),
    typeof e !== 'number')
  ) {
    return;
  }
  ...
  (t === o && (a -= e),
  (t.min = as(t.min, e, n, a, i)),
  (t.max = as(t.max, e, n, a, i)));
}
...
const Ql = ['x', 'scaleX', 'originX'],
  tu = ['y', 'scaleY', 'originY'];
function us(t, e, n, s) {
  (ls(t.x, e, Ql, n ? n.x : void 0, s ? s.x : void 0),
  ls(t.y, e, tu, n ? n.y : void 0, s ? s.y : void 0));
}
function cs(t) {
...
function Ji({
  ...
  return class {
    ...
    mount(r) {
      ...
      ((this.isSVG = mi(r) && !Qo(r)), (this.instance = r));
        ...
        t(r, () => {
          ...
          d !== h &&
              ...
              Ut.hasAnimatedSinceResize &&
                ((Ut.hasAnimatedSinceResize = !1), this.nodes.forEach(ys)));
        }));
      }
          ...
          this.addEventListener(
            ...
            ({
              ...
              if (
                ...
                const g = { ...Ze(m, 'layout'), onPlay: v, onComplete: y };
    ...
    startUpdate() {
      this.isUpdateBlocked() ||
        ((this.isUpdating = !0),
        this.nodes && this.nodes.forEach(mu),
        this.animationId++);
    }
    ...
    resetTransform() {
      ...
      const r =
        ...
        a = this.projectionDelta && !Yi(this.projectionDelta),
    ...
    removeTransform(r) {
      ...
      for (let l = 0; l < this.path.length; l++) {
        ...
        Ae(c.latestValues) && c.updateSnapshot();
        const u = C(),
          h = c.measurePageBox();
        (N(u, h),
        us(a, c.latestValues, c.snapshot ? c.snapshot.layoutBox : void 0, u));
      }
      return (tt(this.latestValues) && us(a, this.latestValues), a);
    }
    setTargetDelta(r) {
      ((this.targetDelta = r),
    ...
    resolveTargetDelta(r = !1) {
      ...
      if (!(!this.layout || !(u || h))) {
        ...
        if (
          ...
          (this.target ||
            ((this.target = C()), (this.targetWithTransforms = C())),
          this.relativeTarget &&
          this.relativeTargetOrigin &&
          this.relativeParent &&
    ...
    calcProjection() {
      ...
      const h = this.treeScale.x,
        f = this.treeScale.y;
      (Oa(this.layoutCorrected, this.treeScale, this.path, a),
      r.layout &&
          !r.target &&
          (this.treeScale.x !== 1 || this.treeScale.y !== 1) &&
          ((r.target = r.layout.layoutBox), (r.targetWithTransforms = C())));
      const { target: d } = r;
      if (!d) {
    ...
    setAnimationOrigin(r, a = !1) {
      ...
      ((this.mixTargetDelta = A => {
        ...
        this.relativeTarget &&
            ...
            gu(this.relativeTarget, this.relativeTargetOrigin, f, P),
            g && eu(this.relativeTarget, g) && (this.isProjectionDirty = !1),
            g || (g = C()),
            N(g, this.relativeTarget)),
        v &&
            ((this.animationValues = u), Yl(u, c, this.latestValues, P, T, p)),
        this.root.scheduleUpdateProjection(),
        this.scheduleRender(),
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(iu),
        this.currentAnimation.stop()),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!a || !l || !c)) {
        ...
        (N(a, l),
        ut(a, u),
        Pt(this.projectionDeltaWithTransform, this.layoutCorrected, a, u));
      }
    }
    registerSharedNode(r, a) {
      (this.sharedNodes.has(r) || this.sharedNodes.set(r, new nu()),
    ...
    resetSkewAndRotation() {
      ...
      for (let u = 0; u < ae.length; u++) {
        (le(`rotate${ae[u]}`, r, c, this.animationValues),
        le(`skew${ae[u]}`, r, c, this.animationValues));
      }
      r.render();
      for (const u in c) {
    ...
    applyProjectionStyles(r, a) {
      ...
      if (this.needsReset) {
        ...
        (r.visibility = ''),
        (r.opacity = ''),
        (r.pointerEvents = Nt(a?.pointerEvents) || ''),
      ...
      for (const m in Mt) {
        ...
        const { correct: v, applyTo: y, isCSSVariable: p } = Mt[m],
      ...
      this.options.layoutId &&
        (r.pointerEvents = c === this ? Nt(a?.pointerEvents) || '' : 'none');
    }
    clearSnapshot() {
...
function au(t) {
  ...
  if (t.isLead() && t.layout && e && t.hasListeners('didUpdate')) {
    ...
    Pt(r, n, e.layoutBox);
    const a = ct();
    o ? Pt(a, t.applyTransform(s, !0), e.measuredBox) : Pt(a, n, e.layoutBox);
    const l = !Yi(r);
    let c = !1;
    if (!t.resumeFrom) {
...
const vu = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
  ...
  Ps = xs('applewebkit/') && !xs('chrome/') ? Math.round : K;
function Ss(t) {
...
function Qi(t, e, n) {
  return (
    t === 'position' || (t === 'preserve-aspect' && !wl(ds(e), ds(n), 0.2))
  );
}
function xu(t) {
...
const Pu = Ji({
  ...
  Su = {
    pan: { Feature: Ul },
    drag: { Feature: Nl, ProjectionNode: tr, MeasureLayout: _i }
  };
function bs(t, e, n) {
  const { props: s } = t;
  t.animationState &&
...
class bu extends J {
  mount() {
    ...
    e &&
      (this.unmount = Xo(
        e,
        (n, s) => (bs(this.node, s, 'Start'), i => bs(this.node, i, 'End'))
      ));
  }
  unmount() {}
}
    ...
    e &&
      (this.unmount = Jo(
        ...
        (n, s) => (
          ...
          (i, { success: o }) => As(this.node, i, o ? 'End' : 'Cancel')
        ),
...
class Ru extends J {
  ...
  startObserver() {
    ...
    return Cu(this.node.current, r, a);
  }
  mount() {
    this.startObserver();
  }
...
const ku = {
  ...
  Fu = { layout: { ProjectionNode: tr, MeasureLayout: _i } },
  Bu = { ...Tl, ...ku, ...Su, ...Fu },
  Uu = Fa(Bu, za);
export { Uu as m };
